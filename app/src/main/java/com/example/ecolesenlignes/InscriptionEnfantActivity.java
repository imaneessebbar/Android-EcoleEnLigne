...
public class InscriptionEnfantActivity extends AppCompatActivity {

    private static final String TAG ="InscriptionEnfantActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inscription_enfant);
        ...
        inputName.addTextChangedListener(new InscriptionEnfantActivity.MyTextWatcher(inputName));
        inputEmail.addTextChangedListener(new InscriptionEnfantActivity.MyTextWatcher(inputEmail));
        inputPrenom.addTextChangedListener(new InscriptionEnfantActivity.MyTextWatcher(inputName));
        inputmotdepassef.addTextChangedListener(new InscriptionEnfantActivity.MyTextWatcher(inputmotdepassef));
        inputconfirmermotdepasse.addTextChangedListener(new InscriptionEnfantActivity.MyTextWatcher(inputconfirmermotdepasse));
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(InscriptionEnfantActivity.this, "Authentication failed.",
