...
public class InfoormationEnfant {
    private String Nom;
    ...
    public InfoormationEnfant()
    {

    }

    public InfoormationEnfant(String nom, String prenom, String niveau, String typeAbo) {
        Nom = nom;
        Prenom = prenom;
        Niveau = niveau;
        TypeAbo = typeAbo;
    ...
    public InfoormationEnfant(int i) {
     this.EnfantRang=i;
    }
