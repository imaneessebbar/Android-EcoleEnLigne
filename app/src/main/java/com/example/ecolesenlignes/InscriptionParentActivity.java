...
public class InscriptionParentActivity extends AppCompatActivity {
    private static final String TAG ="InscriptionParentActivity" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inscription_parent);
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent intent=new Intent(getApplicationContext(), InscriptionParentEnfantInformationActivity.class);
                                ...
                                Toast.makeText(InscriptionParentActivity.this, "Authentication failed.",
