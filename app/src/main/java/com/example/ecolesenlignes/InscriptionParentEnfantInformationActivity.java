...
public class InscriptionParentEnfantInformationActivity extends AppCompatActivity {
    private static final String TAG = "SignupParentEnfantInfo";
    private ArrayList<InfoormationEnfant> mEnfant=new ArrayList<InfoormationEnfant>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inscription_parent_enfant_information);
        ...
        FirebaseOptions firebaseOptions = new FirebaseOptions.Builder()
                ...
                .setApplicationId("ecolesenlignes-1ca1a").build();
        ...
        if(b!=null)
        {
            ...
            for(int i=0;i<j;i++)
            {
                mEnfant.add(new InfoormationEnfant(i+1));
            }
            RecyclerView recyclerView=findViewById(R.id.recyclerView);
            ListEnfantAdapter adapter=new ListEnfantAdapter(this,mEnfant,j);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ArrayList<InfoormationEnfant> List = adapter.getArrayList();
                boolean flag=true;
                ...
                if (flag){
                    Toast.makeText(InscriptionParentEnfantInformationActivity.this, "information inséré avec succés", Toast.LENGTH_SHORT).show();


                    for(int i=0;i<List.size();i++)
                    {
                        String email=List.get(i).getPrenom()+"."+List.get(i).getNom()+"@EcoleEnLigne.com";
                        ...
                        auth2.createUserWithEmailAndPassword(email, motDePasse)
                                .addOnCompleteListener(InscriptionParentEnfantInformationActivity.this, new OnCompleteListener<AuthResult>() {
                                    @Override
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(InscriptionParentEnfantInformationActivity.this, "Authentication failed.",
                    ...
                    Toast.makeText(InscriptionParentEnfantInformationActivity.this, "vous avez oublié des champs veuillez réessayer", Toast.LENGTH_SHORT).show();
                }
    ...
    protected void sendEmail(String Destination,ArrayList<InfoormationEnfant> ListEnfantLogin) {
        ...
        new SendMailTask(InscriptionParentEnfantInformationActivity.this).execute(fromEmail,
