...
public class EcranDemmarageActivity extends AppCompatActivity {
    Animation topAnim, bottomAnim;
    ImageView image;
    TextView slogan;
    FirebaseAuth mAuth;
    private FirebaseFirestore db;
    String TAG="EcranDemmarageActivity";
            ...
            public void run() {
                if(mAuth.getCurrentUser()==null) {
                    ...
                    if(!previouslyStarted) {
                        ...
                        edit.commit();
                        Intent intent = new Intent(EcranDemmarageActivity.this, Presentation.class);
                        startActivity(intent);
                    }
                    else {
                        Intent intent = new Intent(EcranDemmarageActivity.this, LoginActivity.class);
                        startActivity(intent);
                    }
                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    if (document.get("nombreEnfant") != null) {
                                        ...
                                        Intent intent = new Intent(EcranDemmarageActivity.this, MainActivity.class);
