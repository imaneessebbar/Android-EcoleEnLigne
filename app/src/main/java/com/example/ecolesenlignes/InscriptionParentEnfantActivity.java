...
public class InscriptionParentEnfantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inscription_parent_enfant);
        ...
        inputNameEnfant.addTextChangedListener(new MyTextWatcher(inputNameEnfant));
        inputPrenomEnfant.addTextChangedListener(new MyTextWatcher(inputPrenomEnfant));
